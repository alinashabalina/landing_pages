<template>
    <div class="card__wrapper">
        <div class="card__always-visible">
            <img class="card__main-pic" src="@/assets/clothes1.png">
...
<script lang="ts" src="./card-item.ts"></script>
<style lang="scss" src="./card-item.scss">
</style>